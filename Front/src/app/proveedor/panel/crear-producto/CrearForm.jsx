...
export default function CrearProductoForm({ baseUrl, token, proveedorId, usuario, creditosDisponibles }) {
    ...
    const handleAddImages = async e => {
        ...
        try {
            ...
            setImages(prev => [...prev, ...(Array.isArray(uploaded) ? uploaded : [uploaded])]);
        } finally {
            setUploading(false);
        }
    };
