...
export interface ApiContrasenaContrasena extends Struct.CollectionTypeSchema {
  collectionName: 'contrasenas';
  info: {
    displayName: 'contrasena';
    pluralName: 'contrasenas';
    singularName: 'contrasena';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    contrasena_acceso: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiEventoEvento extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    destacar: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
...
export interface ApiVentaSeguraVentaSegura extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    token_entrega: Schema.Attribute.String & Schema.Attribute.Unique;
    token_usado: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::contrasena.contrasena': ApiContrasenaContrasena;
